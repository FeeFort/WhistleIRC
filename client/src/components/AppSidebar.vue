              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  >
                    ...
                    <button type="button" class="app-sidebar__chat-close" v-tooltip.top="'Close chat'" :aria-label="`Close ${channel.lobby?.name || channel.label} chat`" @click.stop="requestCloseChat(channel)">
                      <X :size="11" />
                    </button>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
