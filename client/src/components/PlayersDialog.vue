    ...
    <div class="players-dialog__list" :class="{ 'players-dialog__list--with-players': hasPlayers }">
      <div
        ...
        :class="{
          ...
          'players-dialog__row--dragging': draggedPlayer?.name === player.name,
        }"
...
.players-dialog__list:not(.players-dialog__list--with-players) .players-dialog__drag {
  display: none;
}
...
.players-dialog__action-button--host.p-button {
  color: var(--p-yellow-400, #eab308) !important;
}
.players-dialog__action-button--host.p-button:hover {
  color: var(--p-yellow-400, #eab308) !important;
