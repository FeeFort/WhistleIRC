...
const CrownOff = {
  render: () =>
    h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, [
      ...
      h("path", { d: "M18 18h-13l-1.865 -9.327a.25 .25 0 0 1 .4 -.244l4.465 3.571l1.6 -2.4m1.596 -2.394l.804 -1.206l4 6l4.464 -3.571a.25 .25 0 0 1 .401 .244l-1.363 6.818" }),
      h("path", { d: "M3 3l18 18" }),
    ]),
};
...
const commandGroups = computed(() => [
  ...
  },
  {
    ...
    commands: [
      {
        id: BUILTIN_IDS.CLEAR_HOST,
        label: "Clear host",
        command: "!mp clearhost",
        icon: CrownOff,
        tone: "red",
      },
      {
