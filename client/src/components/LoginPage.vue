  ...
  <main class="login-page">
    <section class="login-card" aria-labelledby="login-title">
        ...
        <form v-if="setupStep === 1" class="login-form" @submit.prevent="saveOsuCredentials">
          ...
          <div class="login-callback-warning">
            ...
            <div class="login-callback-warning__content">
              ...
              <button v-tooltip.top="'Copy callback URL'" type="button" class="login-callback" @click="copyCallbackUrl">
                <Copy :size="14" />
      ...
      <div v-if="!showSetup" class="login-form__osu-profile">
        ...
        <Button v-tooltip.top="'Log out from osu!'" text class="login-form__osu-logout" aria-label="Log out from osu!" @click="logoutFromOsu">
          <LogOut :size="15" />
        </Button>
      </div>
